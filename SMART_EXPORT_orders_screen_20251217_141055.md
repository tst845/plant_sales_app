# Умный экспорт: app\ui\screens\orders_screen.py
**Дата:** 2025-12-17 14:10:55
**Целевой файл:** `app\ui\screens\orders_screen.py`
...
**ЦЕЛЕВОЙ ФАЙЛ**  
**Размер:** 22412 байт  
**Импортирует:** `datetime, kivy, kivymd`  
```python
# app/ui/screens/orders_screen.py
...
- **Всего файлов:** 15
- **Целевой файл:** `app\ui\screens\orders_screen.py`
- **Зависимостей найдено:** 14
- **Общий размер:** 245838 байт (240.1 KB)
